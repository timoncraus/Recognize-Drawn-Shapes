...
pygame.display.set_caption('Андромеда')
...
while running:
        ...
        clear_block = [x_table+40*block//2-block*9//2, y_table+40*block+20, block*9, block*3]
        ...
        screen.blit(textsurface,(x_table+40*block//2+6-block*9//2, y_table+40*block+20, block*9, block*3))
